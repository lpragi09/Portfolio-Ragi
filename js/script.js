document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        'en': {
            ...
            'proj-coffe-title': 'Project 2: Coffee brand website',
            'proj-coffe-desc': 'Development of a responsive website using HTML, CSS and JavaScript to display a coffee shop.',
        ...
        'pt': {
            ...
            'proj-coffe-title': 'Projeto 2: Site marca de café',
            'proj-coffe-desc': 'Desenvolvimento de um site web responsivo utilizando HTML, CSS e JavaScript para exibir um coffe shop.',
